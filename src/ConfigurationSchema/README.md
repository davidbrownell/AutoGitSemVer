The file `../AutoGitSemVer/AutoGitSemVerSchema.json` is build using https://github.com/davidbrownell/v4-Common_SimpleSchema with the input file `./AutoGitSemVerSchema.SimpleSchema`.
